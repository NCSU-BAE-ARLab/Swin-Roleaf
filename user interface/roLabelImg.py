...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, defaultFilename=None, defaultPrefdefClassFile=None):
        ...
        self.dock = QDockWidget(u'Azimuth angles', self)
        ...
        self.filedock = QDockWidget(u'Azimuth distribution', self)
        ...
        verify = action('&Correct wrong label', self.verifyImg,
    ...
    def saveLabels(self, annotationFilePath):
        ...
        try:
            if self.usingPascalVocFormat is True:
                ...
                plt.show()
                # xlabel
                plt.xlabel("Leaf Azimuth Angle")
                # ylabel
                plt.ylabel("Frequency")
                # title
                plt.title("Leaf Azimuth Angle frequency histogram")
            else:
